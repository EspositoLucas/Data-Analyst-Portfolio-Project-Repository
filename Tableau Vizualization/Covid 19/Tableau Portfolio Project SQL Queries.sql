...
Select SUM(new_cases) as total_cases_per_million, SUM(cast(new_deaths as int)) as total_deaths, SUM(cast(new_deaths as int))/SUM(New_Cases)*100 as DeathPercentage
...
-- Wake these out as they are not inluded in the above queries and want to stay consistent
